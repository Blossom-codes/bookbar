                            ...
                            <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                <form action="#">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="singin-email" name="singin_email" required>
                                    </div><!-- End .form-group -->
            ...
            <div class="row no-gutters bg-white newsletter-popup-content">
                <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                    <div class="banner-content text-center">
                        <img src="../../../public/assets/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60" height="15">
...
<script src="../../../public/assets/js/demos/demo-2.js"></script>
</body>
